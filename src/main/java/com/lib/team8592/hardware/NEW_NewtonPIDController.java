 ...
 */
public class NEW_NewtonPIDController implements Sendable {
   ...
   */
  private NEW_NewtonPIDController(
  ...
  public NEW_NewtonPIDController(PIDProfile pidGains, double period) {
    this(
        pidGains.kP, 
        pidGains.kI, 
        pidGains.kD, 
    ...
    this.m_controller = pidGains.toPIDController();
  }

  public NEW_NewtonPIDController(PIDProfile pidGainsPidProfile) {
    this(pidGainsPidProfile, 0.02);
  }
...
//   }
  ...
  public double calculate(double measurement) {
    ...
    return m_controller.calculate(measurement, m_setpoint.position) + (
        pidGains.feedForward.calculate(m_goal.position, getPeriod()) * 
        Math.abs(m_goal.position));
  }
