...
public class OLD_SmartLogger {
    ...
    public OLD_SmartLogger(String name, boolean logToShuffleboard) {
        this.tableName = name;
        this.logToShuffleboard = logToShuffleboard;
        // this.cards = new Hashtable<>();
    }

    public OLD_SmartLogger(String name) {
        this(name, true);
    }
    ...
    public OLD_SmartLogger initialize() {
    ...
    public OLD_SmartLogger enable(boolean enable) {
        this.logToShuffleboard = enable;
        return this;
    }

    public OLD_SmartLogger enable() {
        return this.enable(true);
    }

    public OLD_SmartLogger disable() {
        return this.enable(false);
    }

    public OLD_SmartLogger addSendable(Sendable sendable) {
        this.shuffleboardTab.add(sendable);
        return this;
    }

    public OLD_SmartLogger addSendable(String key, Sendable sendable) {
