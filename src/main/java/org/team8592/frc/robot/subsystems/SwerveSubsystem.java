...
import org.team8592.lib.hardware.swerve.CTRESwerve.SpeedConstants;
...
public class SwerveSubsystem extends NewtonSubsystem {
    ...
    protected SwerveSubsystem(boolean logToShuffleboard) {
        ...
        SpeedConstants speedConstants = new SpeedConstants(
            ...
            SWERVE.MAX_ROTATIONAL_VELOCITY_RADIANS_PER_SECOND
        );

        swerve = new CTRESwerve(drivetrainConstants, speedConstants, commonSwerveConstants, frontLeft, frontRight, backLeft, backRight);
    ...
    public void resetHeading(){
        swerve.resetHeading(Suppliers.currentGyroscopeRotationOffset);
    }
